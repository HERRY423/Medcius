...
当前版本为 **`0.2.0-pilot` 工程试点版**，不具备真实临床有效性或生产医院部署证明。P0 临床入口是 HIS 内嵌/院内 SSO 上的查房演变摘要静默试点；Codex 不是一线入口。
...
- 尚无独立真实 EHR 验收、连续病例标注、医生秒表 time-motion 或多中心证据；合成 79% 不得当作提效证明；
