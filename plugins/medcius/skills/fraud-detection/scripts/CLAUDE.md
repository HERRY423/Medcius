...
Every reference table lives in **`~/.claude/data/medcius/fraud-detection/data-cache/reference/<q>/reference.duckdb`**
(override the parent `~/.claude/data/medcius` with `$CLAUDE_MEDCIUS_DATA`) as a named table,
