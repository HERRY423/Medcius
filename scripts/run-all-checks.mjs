...
const steps = [
  ...
  { name: "7. Multi-Center Shadow Mode Clinical Study Engine", cmd: "node", args: ["plugins/medcius/evals/shadow-mode/shadow-study.mjs", "--run-demo"] },
  ...
  { name: "12. Flagship: CDS Hooks 2.0 Integration & Fail-Closed Tests", cmd: "node", args: ["tests/test-cds-hooks.mjs"] },
  { name: "13. Flagship: RESTful API Routes & Security Gate Tests", cmd: "node", args: ["tests/test-api-routes.mjs"] },
  { name: "14. Flagship: Inpatient Pre-Round Patient Evolution Summary Tests", cmd: "node", args: ["tests/test-preround-summary.mjs"] },
  { name: "15. Clinical Evaluation Benchmark & Traps", cmd: "node", args: ["scripts/run-evals.mjs"] },
  { name: "16. Flagship: Cardiology Ward 2 Consecutive Cases Silent Validation", cmd: "node", args: ["plugins/medcius/evals/shadow-mode/ward-consecutive-validation.mjs"] },
  { name: "17. Flagship: Physician Time-Motion Efficiency Clinical Pilot Study", cmd: "node", args: ["plugins/medcius/evals/time-motion/time-motion-study.mjs"] },
  { name: "18. Flagship: Hospital Multi-Source Data Fusion & Adapter Tests", cmd: "node", args: ["tests/test-multisource-adapter.mjs"] },
  { name: "19. Flagship: Clinical Safety Guardrails & Quality Control Tests", cmd: "node", args: ["tests/test-clinical-safety-rules.mjs"] },
];
