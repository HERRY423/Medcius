...
const supervisorPath = existsSync(join(repoRoot, "experimental", "orchestrator", "supervisor.mjs"))
  ? join(repoRoot, "experimental", "orchestrator", "supervisor.mjs")
  : join(repoRoot, "plugins", "medcius", "orchestrator", "supervisor.mjs");

if (existsSync(supervisorPath)) {
  const supervisorSrc = readFileSync(supervisorPath, "utf8");
...
const codingWorkerPath = existsSync(join(repoRoot, "experimental", "orchestrator", "workers", "coding-worker.mjs"))
  ? join(repoRoot, "experimental", "orchestrator", "workers", "coding-worker.mjs")
  : join(repoRoot, "plugins", "medcius", "orchestrator", "workers", "coding-worker.mjs");

if (existsSync(codingWorkerPath)) {
  const codingWorkerSrc = readFileSync(codingWorkerPath, "utf8");
...
const pharmaWorkerPath = existsSync(join(repoRoot, "experimental", "orchestrator", "workers", "pharma-worker.mjs"))
  ? join(repoRoot, "experimental", "orchestrator", "workers", "pharma-worker.mjs")
  : join(repoRoot, "plugins", "medcius", "orchestrator", "workers", "pharma-worker.mjs");

if (existsSync(pharmaWorkerPath)) {
  const pharmaWorkerSrc = readFileSync(pharmaWorkerPath, "utf8");
...
const auditWorkerPath = existsSync(join(repoRoot, "experimental", "orchestrator", "workers", "audit-worker.mjs"))
  ? join(repoRoot, "experimental", "orchestrator", "workers", "audit-worker.mjs")
  : join(repoRoot, "plugins", "medcius", "orchestrator", "workers", "audit-worker.mjs");

if (existsSync(auditWorkerPath)) {
  const auditWorkerSrc = readFileSync(auditWorkerPath, "utf8");
